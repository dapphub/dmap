...
const { b32, send, want} = require('minihat')
...
describe('rootzone', ()=>{
    ...
    it('cooldown', async ()=>{
        ...
        await wrap_send(provider, rootwrap, rootwrap.hark, commitment, { value: ethers.utils.parseEther('1'), gasLimit: 100000 } )
        await check_entry(dmap, rootzone.address, b32('zone1'), constants.HashZero, constants.HashZero)
    })
    ...
    it('fee', async ()=>{
        ...
        const commitment = getCommitment(b32('zone1'), zone1)
        await wrap_fail(provider, rootwrap, 'ErrPayment()', rootwrap.hark, commitment, { gasLimit: 100000 })
        ...
        await wrap_send(provider, rootwrap, rootwrap.hark, commitment, { value: ethers.utils.parseEther('1.0'), gasLimit: 100000 })
    ...
    it('etch fail wrong hash', async ()=>{
        ...
        const commitment = getCommitment(b32('zone1'), zone1)
        await wrap_send(provider, rootwrap, rootwrap.hark, commitment, { value: ethers.utils.parseEther('1'), gasLimit: 100000 })
        await wrap_fail(provider, rootwrap, 'ErrExpired()', rootwrap.etch, b32('wrong_salt'), b32('zone1'), zone1, {gasLimit: 100000} )
        await wrap_send(provider, rootwrap, rootwrap.etch, b32('salt'), b32('zone1'), zone1, {gasLimit: 1000000})
